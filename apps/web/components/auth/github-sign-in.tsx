...
export const    GitHubSignInButton: FC<Props> = ({ handleSignIn, clientId }) => {
  ...
  return (
    <div className="w-full">
      ...
      >
        <Button className="flex h-[46px] w-full items-center justify-center gap-2 rounded border border-gray-600 bg-gray-700  p-2 text-sm font-medium text-primary-foreground duration-300 hover:bg-primary/80">
          <Image
