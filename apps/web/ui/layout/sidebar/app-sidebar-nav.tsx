...
import { useRouterStuff } from "@app/ui";
import {
  Brush,
  CircleInfo,
  ConnectedDots,
        ...
        items: [
          {
            ...
            icon: Hyperlink,
            href: `/${slug}/links${
              pathname === `/${slug}/links` ? "" : queryString
            }`,
        ...
        items: [
          {
            ...
            icon: LinesY,
            href: `/${slug}/analytics${
              pathname === `/${slug}/analytics` ? "" : queryString
            }`,
          },
          {
            name: "Events",
            icon: CursorRays,
            href: `/${slug}/events${
              pathname === `/${slug}/events` ? "" : queryString
            }`,
          },
          {
            name: "Customers",
  ...
  return (
    <SidebarNav
      ...
      data={{
        ...
        showNews: !pathname.startsWith(`/${slug}/program`),
